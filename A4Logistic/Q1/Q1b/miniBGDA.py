...
def miniBGDA(features_matrix, output, alpha, epsilon, max_iter, initial_weights, size):
	converge = False
...
weights, vec = miniBGDA(features_matrix, output, alpha, epsilon, max_iter, initial_weights, size)
...
weights_sc, vec_sc = miniBGDA(features_matrix_sc, output, alpha, epsilon, max_iter, initial_weights_sc, size)
