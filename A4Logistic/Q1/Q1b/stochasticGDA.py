...
def stochasticGDA(features_matrix, output, alpha, epsilon, max_iter, initial_weights):
	converge = False
...
weights, vec = stochasticGDA(features_matrix, output, alpha, epsilon, max_iter, initial_weights)
...
weights_sc, vec_sc = stochasticGDA(features_matrix_sc, output, alpha, epsilon, max_iter, initial_weights_sc)
